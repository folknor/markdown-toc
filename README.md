...
* Can optionally be used as a [marked](https://github.com/markedjs/marked) parser
...
Use as a [marked](https://github.com/markedjs/marked) parser.

```js
var toc = require('markdown-toc');

function render(str, options) {
  return toc(str, options);
}
```
